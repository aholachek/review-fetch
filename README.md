Sometimes it's helpful to review the basic building blocks of front end development. In this repo you'll find a few short exercies you can do to (re)familiarize yourself with the `fetch` function.
